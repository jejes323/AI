...
# 名詞の WordCloud
wc_noun = WordCloud(width=640, height=480, font_path=font_path_gothic, background_color="white")
wc_noun.generate(noun_text)

# 形容詞の WordCloud
wc_adj = WordCloud(width=640, height=480, font_path=font_path_gothic, background_color="white")
wc_adj.generate(adj_text)
